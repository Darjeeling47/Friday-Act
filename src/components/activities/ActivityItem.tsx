    ...
    >
        ...
        <div className="flex flex-col justify-between items-between w-full h-full">
          <div className="flex flex-col justify-start items-start gap-3 w-full">
            ...
            <div className="line-clamp-1 sm:line-clamp-2 lg:line-clamp-3 w-full font-light text-footnote text-left text-mgray-2">
              {activity.description}
            </div>
          </div>
          {
            availableSeats ? (
              <p className='font-light text-body text-emerald-500 text-left'>{availableSeats} Seat{availableSeats !== 1 ? "s" : ""} left</p>
            ) : (
              <p className='font-light text-body text-left text-rose-600'>Full</p>
            )
          }
        </div>
    </button>
